...
/**
 * Осуществляет разбор содержимого символьного потока на токены. В качестве разделителя токенов используется некоторый заданный символ.<br/>
 * Данный вид токенизатора позволяет обойтись минимумом памяти при парсинге файлов любых размеров.
 * @author Anton Sharapov
 */
public final class FastStreamTokenizer implements Iterator<String> {
    ...
    private Reader reader;              // Поток символов который требуется разобрать на токены.
